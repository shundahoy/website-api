...
Route::get('/services', [ServiceController::class, 'onAllSelect']);

Route::get('/projecthome', [ProjectController::class, 'onSelectThree']);
Route::get('/projectall', [ProjectController::class, 'onAllSelect']);
Route::post('/projectdetail', [ProjectController::class, 'onSelectDetails']);

Route::get('/home/video', [HomePageEtcController::class, 'onSelectVideo']);
